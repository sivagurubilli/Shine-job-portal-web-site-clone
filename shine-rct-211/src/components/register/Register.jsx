...
const [isworked,setisworkrd]= useState(false)
 ...
 <div  className={styles.mid}>
       <div className={styles.contimg}>
        <img src = "https://static1.shine.com/c/s1/bundles/Winter__Registration-3e833dd.png"
         />
         <h2>Register with shine</h2>
         <br/>
       <span>Upload your  resume     </span>     <button>Resume</button>
...
<p style={{display:"flex", flexDirection:"row"}}><span><hr width="135px"/></span><span style={{width:"10px"}}></span> <span style={{color:"gray"}}>or</span> <span style={{width:"10px"}}></span> <span><hr width="135px"/></span></p>    
...
<p style ={{fontSize:"15px",fontweight:"400", color:"#6d7883"}}>Thanks for registering. compleate your profile</p>
...
non-binary</button>
<button className={styles.identity}onClick={()=>setgender("male")}>
    <div className={styles.identity4} width="50px" style={{marginLeft:"20px",marginTop:"10px"}}></div>
prefer not to disclose</button>
...
<div className={styles.cont}>
    <div className={styles.container}>
        <div className={styles.container2}>``
    <h4 style={{fontSize:"28px", fontweight:"800",marginRight:"20%",marginTop:"3px"}}>which city you live in?</h4>
